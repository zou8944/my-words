...
> Voicelab提供开源TTS模型的优化API，支持CSM-1B和Orpheus等模型，通过优化推理架构和后期训练提升语音质量和扩展性。
...
> 开发者创建了本地语音转文本工具hns，使用faster-whispe实现终端录音转文字，支持离线运行且数据不外传，适合编程讨论和LLM输入。MIT协议开源，可通过pipx安装。
...
### 16. [Show HN：Piper-mode——Emacs 文本转语音插件（基于Piper TTS引擎）](https://news.ycombinator.com/item?id=44387470)
