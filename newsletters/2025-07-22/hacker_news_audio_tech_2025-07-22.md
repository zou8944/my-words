...
### 8. [Show HN：适用于sway-Linux的简易语音转写/听写脚本](https://news.ycombinator.com/item?id=44467937)
...
### 11. [Show HN：我开发了一款本地语音转文字工具，可将思绪直接导入Claude Code](https://news.ycombinator.com/item?id=44434864)
> 开发了本地语音转文本工具hns，使用faster-whisper实现终端录音转文字，支持离线运行且数据不外传，适合编程讨论和LLM输入。MIT许可，可通过uv或pipx安装。
...
> 作者指出当前TTS（文本转语音）服务示例大多未优化，如Modal Labs和BentoML使用FastAPI，希望找到基于TritonServer的高效实现方案，避免重复造轮子。
...
### 15. [Show HN: Inworld TTS——高质量、经济实惠的低延迟文本转语音](https://news.ycombinator.com/item?id=44389265)
> Inworld发布两款高质量多语言TTS模型：TTS-1和性能更强的TTS-1-Max，基于LLaMA架构，支持情感标记，延迟低至500ms，价格5美元/百万字符，将开源训练代码。
