...
### 4. [支持零样本语音克隆与说话风格控制的SOTA多语言TTS系统](https://news.ycombinator.com/item?id=44730472)
...
> RoboComic是一个AI生成虚拟喜剧演员对战的应用，支持多语言和自定义角色，开源且无需安装。提供AI讲笑话和语音输出功能。
...
> 开发者创建了基于PyQt的Windows版有声书工具Chatterblez，寻求贡献者支持macOS/Linux和ATI显卡适配。另推荐无显卡用户使用CPU生成有声书的audiblez工具。
...
> Voicelab提供开源TTS模型的优化API，支持CSM-1B和Orpheus等模型。通过优化推理架构和私有数据微调，解决开源模型生产化难题，提升语音质量和扩展性。

<sub>作者: jag729 | 发布于: 2025-07-15 16:58</sub>

---

### 8. [PG论文通过TTS语音合成实现音频版](https://news.ycombinator.com/item?id=44559098)

<sub>作者: caaaadr | 发布于: 2025-07-14 11:59</sub>

---

### 9. [延迟流建模：Kyutai语音识别与合成系统](https://news.ycombinator.com/item?id=44517574)

<sub>作者: jasonjmcghee | 发布于: 2025-07-10 05:29</sub>

---

### 10. [Telnyx推出NaturalHD TTS：带"嗯"、"呃"和笑声的类人语音](https://news.ycombinator.com/item?id=44493162)
...
### 13. [Show HN: 适用于sway-Linux的简易语音转写/听写脚本](https://news.ycombinator.com/item?id=44467937)
...
### 14. [Kyutai 1.6B流式文本转语音模型](https://news.ycombinator.com/item?id=44458858)
...
### 16. [Show HN：我开发了一款本地语音转文字工具，可将想法直接导入Claude Code](https://news.ycombinator.com/item?id=44434864)
> 开发了本地语音转文本工具hns，使用faster-whisper技术，支持离线运行，录音直接转为剪贴板文本，便于与Claude等LLM交互。MIT许可，安装简单。
...
### 20. [Show HN: Inworld TTS – 高质量、经济实惠且低延迟的文本转语音](https://news.ycombinator.com/item?id=44389265)
> Inworld发布高质量TTS模型TTS-1和TTS-1-Max，支持11种语言，基于LLaMA架构，优化延迟至500ms，定价$5/百万字符，将开源训练代码。
