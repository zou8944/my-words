...
### 7. [Show HN：浏览器中实现带同步文本高亮的设备端文本转语音](https://news.ycombinator.com/item?id=45515923)
...
> 开发者分享语音应用开发痛点：实时语音转文本到LLM流程存在准确率下降和延迟叠加问题，寻求优化方案和技术讨论。
...
> 使用Google TPU免费额度训练荷兰语TTS模型，仅用1万小时数据达到ElevenLabs水平。开源了权重和完整训练流程，成本约100-300美元。为其他语言TTS开发提供可行方案。
