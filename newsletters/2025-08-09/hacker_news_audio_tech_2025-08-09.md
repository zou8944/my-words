...
### 7. [Show HN：一款支持无限时长朗读Kindle书籍的iOS文字转语音应用](https://news.ycombinator.com/item?id=44738030)
...
### 8. [支持零样本语音克隆与说话风格控制的SOTA多语言文本转语音技术](https://news.ycombinator.com/item?id=44730472)

<sub>作者: selvan | 发布于: 2025-07-30 02:37</sub>

---

### 9. [Show HN: RoboComic——AI驱动的脱口秀对战（支持TTS语音和自定义角色）](https://news.ycombinator.com/item?id=44693095)
> RoboComic是一个AI生成虚拟喜剧演员对战的应用，支持多语言和自定义角色，使用TTS技术，开源且无需安装。
...
> 开发者创建了基于PyQt的跨平台有声书工具Chatterblez，目前支持Windows，寻求贡献者扩展至macOS/Linux。另推荐无显卡时可用的CPU版有声书生成工具audiblez。
...
### 12. [PG论文通过TTS语音合成音频版](https://news.ycombinator.com/item?id=44559098)
...
### 17. [Show HN: 适用于sway-Linux的简易STT/听写脚本](https://news.ycombinator.com/item?id=44467937)
...
### 20. [Show HN：我开发了一款本地语音转文字工具，可将思绪直接导入Claude Code](https://news.ycombinator.com/item?id=44434864)
