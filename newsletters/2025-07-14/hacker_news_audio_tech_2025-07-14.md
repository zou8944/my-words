...
### 4. [我的TTS工具性能排行榜（2025年7月版）](https://news.ycombinator.com/item?id=44489490)
...
### 8. [Show HN：我开发了一款本地语音转文字工具，可将想法直接导入Claude Code](https://news.ycombinator.com/item?id=44434864)
> 开发者创建了本地语音转文本工具hns，使用faster-whisper实现终端录音转文字，支持离线运行且数据不外传，适合编程讨论和LLM输入。MIT许可，可通过uv或pipx安装。
...
### 12. [Show HN: Inworld TTS – 高质量、经济实惠且低延迟的文本转语音](https://news.ycombinator.com/item?id=44389265)
...
### 14. [Inworld TTS：成本降低20倍，最先进的文本转语音技术](https://news.ycombinator.com/item?id=44379611)
...
### 16. [我用8200万参数神经网络模型打造本地TTS插件——土豆级设备也能运行](https://news.ycombinator.com/item?id=44337290)
...
### 19. [Chatterbox AI：实时语音克隆与文本转语音生成器](https://news.ycombinator.com/item?id=44308242)
