...
### 4. [延迟流建模：Kyutai 语音识别与合成系统](https://news.ycombinator.com/item?id=44517574)
...
### 11. [Show HN：我开发了一款本地语音转文字工具，可将想法直接转存至Claude Code](https://news.ycombinator.com/item?id=44434864)
...
> 作者指出当前文本转语音(TTS)服务示例大多未优化，如Modal Labs和BentoML使用FastAPI的简单实现。希望找到基于TritonServer的高性能方案，支持模型并发和批处理，避免重复造轮子。
