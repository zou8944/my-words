...
### 18. [Show HN：Nabu（Android 文本转语音阅读器与大型语言模型实验平台）](https://news.ycombinator.com/item?id=44907170)
> 谷歌Gemma 3 270M模型新增本地LLM到TTS支持，推理速度显著提升。项目定位为快速迭代的边缘模型实验平台，附带电子阅读器等实用功能开发。
