...
> 使用Google免费TPU训练荷兰语TTS模型，仅需1万小时数据效果媲美ElevenLabs。开源了模型权重和完整训练流程，成本约100-300美元。为其他语言TTS开发提供可行方案。
...
### 17. [评估不同ASR软件包与API的基准测试代码](https://news.ycombinator.com/item?id=45287596)
