...
> 开发者创建了本地语音转文本工具hns，使用faster-whisper技术，支持离线运行，录音内容直接转为剪贴板文本，便于与Claude Code等LLM交互。MIT许可，安装简单。
...
> 作者寻求优化TTS服务的实现方案，指出当前示例（如FastAPI）未优化，建议使用TritonServer提升性能，希望获得相关经验分享避免重复工作。
...
### 17. [Inworld TTS：成本降低20倍，最先进的文本转语音技术](https://news.ycombinator.com/item?id=44379611)
