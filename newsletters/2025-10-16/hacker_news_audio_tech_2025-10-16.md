...
### 4. [Show HN：在浏览器中实现带同步文本高亮的设备端语音合成](https://news.ycombinator.com/item?id=45515923)
...
### 8. [Show HN：用一条命令构建带语音识别/合成和大语言模型的语音助手 CLI](https://news.ycombinator.com/item?id=45413663)
...
> 使用Google免费TPU训练荷兰语TTS模型，仅需1万小时数据即可达到ElevenLabs水平。开源了模型权重和完整训练流程，成本约100-300美元。为其他语言TTS开发提供实用指南。
...
### 15. [Show HN：用 C 语言实现的 STT → LLM → TTS 处理流水线](https://news.ycombinator.com/item?id=45272639)
> 开发者创建了三个C/C++封装库，支持语音转文字、大语言模型推理和文字转语音功能，兼容Windows和Linux系统。
...
### 19. [我开发了一款比ElevenLabs便宜100倍的文字转语音工具](https://news.ycombinator.com/item?id=45151768)
...
> 用户使用LLM研究多种TTS模型，寻求性能与价格最优方案，特别征求语音AI开发者的实际推荐。
