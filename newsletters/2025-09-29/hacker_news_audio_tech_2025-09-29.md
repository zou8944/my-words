## Hacker News 音频技术 - 2025-09-29


### 1. [Show HN: Parkiet – 用不到100美元为任意语言微调大型TTS模型](https://news.ycombinator.com/item?id=45357002)
> 使用Google免费TPU训练荷兰语TTS模型，效果媲美ElevenLabs。开源了权重和完整训练流程，成本仅100-300美元。为其他语言TTS开发提供实用指南。
...
### 3. [本地文本转语音（TTS）与Mlx-Audio语音克隆技术](https://news.ycombinator.com/item?id=45324936)
...
### 5. [评估不同ASR工具包与API的基准测试代码](https://news.ycombinator.com/item?id=45287596)
...
### 8. [Qwen3 ASR：听得清晰，转录智能](https://news.ycombinator.com/item?id=45169263)
...
> MindNote AI笔记工具支持YouTube等视频转录，自动会议转录，改进语音笔记准确性。面向创业者提供终身优惠。

<sub>作者: tommat32 | 发布于: 2025-09-06 19:42</sub>

---

### 10. [我开发了一款比ElevenLabs便宜100倍的文字转语音工具](https://news.ycombinator.com/item?id=45151768)
...
> 用户使用LLM研究TTS模型，寻求性能与价格平衡的最佳推荐，适用于语音AI代理开发者。
...
### 15. [Show HN：Nabu（Android 文本朗读与大语言模型实验平台）](https://news.ycombinator.com/item?id=44907170)
> 谷歌Gemma 3 270M模型新增本地LLM转语音支持，推理速度显著提升。该项目定位为快速迭代的边缘模型实验平台，同时开发电子阅读器等实用功能。

<sub>作者: mewmix | 发布于: 2025-08-15 00:04</sub>

---

### 16. [TTS Studio：测试和比较基于浏览器的TTS模型](https://news.ycombinator.com/item?id=44889900)

<sub>作者: CharlesW | 发布于: 2025-08-13 15:38</sub>

---

### 17. [Hugging Face TTS竞技场V2结果公布（Papla与Async.ai领先ElevenLabs）](https://news.ycombinator.com/item?id=44861142)

<sub>作者: zinagorc | 发布于: 2025-08-11 06:03</sub>

---

### 18. [Hugging Face TTS竞技场V2结果公布（Papla与Async.ai领先ElevenLabs）](https://news.ycombinator.com/item?id=44856995)

<sub>作者: zinagorc | 发布于: 2025-08-10 18:01</sub>

---

### 19. [Hugging Face TTS竞技场V2结果公布（Papla与Async.ai领先ElevenLabs）](https://news.ycombinator.com/item?id=44856714)
