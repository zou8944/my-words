...
### 4. [Hugging Face TTS竞技场V2结果公布（Papla与Async.ai领先ElevenLabs）](https://news.ycombinator.com/item?id=44856995)
...
### 6. [误听：破解微型ASR模型生成达达主义诗歌](https://news.ycombinator.com/item?id=44856410)
...
### 8. [Show HN: Kitten TTS - 仅25MB的纯CPU开源文本转语音模型](https://news.ycombinator.com/item?id=44807868)
...
> 用户寻求替代Pocket的应用，需满足保存长文章和可靠TTS功能，目前使用Chrome阅读列表。

<sub>作者: megahz | 发布于: 2025-08-04 10:11</sub>

---

### 12. [Show HN：Inworld TTS 开源及技术报告](https://news.ycombinator.com/item?id=44763614)
...
### 15. [支持零样本语音克隆与说话风格控制的SOTA多语言TTS系统](https://news.ycombinator.com/item?id=44730472)
