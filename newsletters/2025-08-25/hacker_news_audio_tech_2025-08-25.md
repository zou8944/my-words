...
> 谷歌Gemma 3 270M本地LLM到TTS的推理速度显著提升，项目定位为快速迭代的边缘模型试验平台，寻求社区贡献。
...
### 13. [如何保存文章以供文本转语音使用](https://news.ycombinator.com/item?id=44783867)
...
> iOS开发者推出无限制文本转语音应用，采用高质量AI语音，支持多种文档格式导入，提供自然流畅的听书体验。Android版即将推出。
...
### 18. [Show HN: RoboComic——AI驱动的单口喜剧对战（含TTS语音与自定义角色）](https://news.ycombinator.com/item?id=44693095)
...
> 开发者创建了Chatterblez开源工具用于生成有声书，支持Windows平台并寻求跨平台贡献。另推荐无显卡用户使用audiblez，CPU可在4小时内生成有声书。
...
> Voicelab提供开源TTS模型优化推理API，通过专用音频架构和模型微调解决生产环境中的扩展性和语音质量问题。
