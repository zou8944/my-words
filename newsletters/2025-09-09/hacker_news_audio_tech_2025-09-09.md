...
### 2. [Show HN: AI 笔记工具推出新功能：OCR、升级版语音识别与语音合成](https://news.ycombinator.com/item?id=45152280)
> AI笔记工具MindNote支持多平台转录，包括视频会议和社交媒体，提供自动会议记录和语音笔记功能，适合创业者和团队协作。
...
> 谷歌Gemma 3 270M本地LLM到TTS的推理速度显著提升，项目定位为快速迭代的边缘模型试验场，同时开发电子阅读器等实用功能。
...
### 10. [Hugging Face TTS竞技场V2结果公布（Papla与Async.ai领先ElevenLabs）](https://news.ycombinator.com/item?id=44861142)
...
### 15. [Show HN：Kitten TTS——仅需25MB的纯CPU开源语音合成模型](https://news.ycombinator.com/item?id=44807868)
...
### 18. [如何保存文章用于TTS朗读](https://news.ycombinator.com/item?id=44783867)
