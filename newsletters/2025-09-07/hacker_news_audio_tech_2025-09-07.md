## Hacker News 音频技术 - 2025-09-07


### 1. [Show HN: AI 笔记工具推出新功能：OCR、升级版语音转文字与文字转语音](https://news.ycombinator.com/item?id=45152280)
> AI笔记工具MindNote新增视频转录功能，支持YouTube等平台及主流会议软件自动转录，提高语音笔记准确性，提供终身套餐。
...
> 用户使用LLM深入研究TTS模型，寻求性能与价格最优推荐，特别针对语音AI开发者。
...
> Google推出Gemma 3 270M本地LLM模型，文本生成速度显著提升。项目处于开发阶段，旨在构建快速演进的边缘模型试验平台，并探索电子阅读器等实用功能。
...
### 9. [Hugging Face TTS竞技场V2结果公布（Papla与Async.ai领先于ElevenLabs）](https://news.ycombinator.com/item?id=44861142)
...
### 11. [Hugging Face TTS竞技场V2结果公布（Papla与Async.ai领先ElevenLabs）](https://news.ycombinator.com/item?id=44856714)

<sub>作者: leysan | 发布于: 2025-08-10 17:24</sub>

---

### 12. [误听：破解微型ASR模型创作达达主义诗歌](https://news.ycombinator.com/item?id=44856410)
...
### 14. [Show HN：Kitten TTS – 仅需25MB的CPU开源语音合成模型](https://news.ycombinator.com/item?id=44807868)
...
### 15. [Kitten TTS：仅需25MB、纯CPU运行的开源语音模型](https://news.ycombinator.com/item?id=44806543)
...
### 17. [如何保存文章以便进行文本转语音](https://news.ycombinator.com/item?id=44783867)
...
### 20. [Show HN：一款可朗读 Kindle 书籍且无时长限制的 iOS 文字转语音应用](https://news.ycombinator.com/item?id=44738030)
