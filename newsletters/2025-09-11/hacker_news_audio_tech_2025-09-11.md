...
### 2. [Show HN: AI 智能笔记工具推出新功能：OCR、升级版语音转文字与文字转语音](https://news.ycombinator.com/item?id=45152280)
> MindNote AI笔记工具支持多平台会议转录和视频转文字，提高语音记录准确性，集成主流办公协作工具。
...
> 用户使用LLM研究TTS模型，寻求性能与价格最优方案，征求语音AI开发者的推荐建议。
...
> 谷歌Gemma 3 270M本地LLM模型支持TTS功能，推理速度显著提升。项目处于开发阶段，旨在构建快速迭代的边缘模型试验平台，并探索电子阅读器等实用功能。
...
### 15. [Show HN：Kitten TTS —— 仅需25MB内存、纯CPU运行的开源TTS模型](https://news.ycombinator.com/item?id=44807868)
> Kitten TTS发布25MB超小语音合成模型，支持8种英语语音，可在树莓派等边缘设备无GPU运行，专为高频低成本应用设计。
