## Hacker News 音频技术 - 2025-07-30


### 1. [Show HN: RoboComic——AI驱动的脱口秀对战（支持TTS语音与自定义角色）](https://news.ycombinator.com/item?id=44693095)
...
### 4. [PG论文通过TTS语音合成实现有声版](https://news.ycombinator.com/item?id=44559098)
...
### 8. [我的TTS工具性能排行榜（2025年7月）](https://news.ycombinator.com/item?id=44489490)
...
### 12. [Show HN：我开发了一款本地语音转文字工具，可将想法直接转存至Claude Code](https://news.ycombinator.com/item?id=44434864)
> 开发了本地语音转文本工具hns，使用faster-whisper技术，支持离线运行，录音直接转为剪贴板文本，便于与Claude等LLM交互。MIT协议，安装简单。
...
> 作者寻求优化TTS服务部署方案，指出现有FastAPI示例效率低，建议使用TritonServer实现模型并发和批处理，希望借鉴他人经验避免重复造轮子。
